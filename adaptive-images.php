...
$resolutions   = array(1600, 1382, 992, 735, 620, 480); // the resolution break-points to use (screen widths, in pixels)
$cache_path    = "images-cache"; // where to store the generated re-sized images. Specify from your document root!
